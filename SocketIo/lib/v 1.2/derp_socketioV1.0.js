/*to call this do the following in your "parent" file
    Qt.include('./after.js');
...
var Derp = (function (){
    ...
    console.log("DERP FUNCTION!")
    function superDerp()
    {
        console.log("I AM SUPER DERP MAN");
    }

    derpObj.derpOut = function (derpyText)
    {
        superDerp();
        console.log(" DERP OUT TO CONSOLE! " + derpyText)
    }
    return derpObj
})();
...
var Utf8 = (function (globalObject) {
    console.log("UTF8 function start global =",globalObject)
    ...
    function readContinuationByte() {
        if (byteIndex >= byteCount) {
            console.log("UTF8 function: " +'Invalid byte index');
        }
        ...
        console.log("UTF8 function: " +'Invalid continuation byte');
    }
    ...
    function decodeSymbol() {
        ...
        console.log("UTF8 function: " +'Invalid UTF-8 detected');
    }
...
//    var Blob = new Blob
    ...
    console.log("packetslist",packetslist)
    /**
    ...
    ParserCoder.decodePacket = function (data, binaryType, utf8decode) {
        // String data
        console.log("DATA decode Packet()= ",data)
        ...
        if (typeof data == 'string' || data === undefined) {
            ...
            if (false)//(utf8decode)
            {
                try {
//                    data = data.substr(1)
                    console.log("WE LOVE THE WOLFY",typeof global.utf8.decode)
                    ...
                    console.log("decodepacket () DATA LENGTH",data.length)
                } catch (e) {
                    console.log("error= ")
                    console.trace()
                    console.exception()
            ...
            console.log("decodePacket() type",type)
            var packetslist = []
            for (var c in packets)
            ...
            if (data.length > 1)
            {
                console.log("decodePacket() - data.length > 1")
                return {
                ...
                console.log("decodePacket() - data.length == 0")
                return {
                    type : packetslist[type]
                };
            }
...
//        console.log("I'M GONNA DO IT FO REAL GUYS")
//        do
//        {
//            console.log("looping over message")
//            i = data.indexOf(":",n+1)
//            if(i != -1)
//            {
...
//                console.log("msg i N",i,n)
//                packet = ParserCoder.decodePacket(msg, binaryType, true);

//                if (err.type == packet.type && err.data == packet.data)
//                {
//                    console.log("ERROR decodePacket(), errorType -",err.type)
...
//        }while(i != -1)
        ...
        console.log("DecodePayload() - Data",data)
        var i = data.indexOf(":")
        msg = data.substr(i+1)
        packet = ParserCoder.decodePacket(msg,binaryType,true);
        if (err.type == packet.type && err.data == packet.data)
        ...
        var ret = callback(packet, data.length - (i+1), data.length);
        if (false === ret)
            return;
...
//            {
//                n = data.indexOf(":",i+1)
//                if (n == -1 || length == 0) // parser error - ignoring payload
//                {
//                    console.log("ERROR decodePacket() length is 0")
//                    return callback(err, 0, 1);
//                }
...
//        }
    ...
    console.log("parser coder complete");
...
var ArrayBufferSlice
{
    function slice (arraybuffer, start, end) {
        ...
        if (start >= bytes || start >= end || bytes === 0) {
             console.log("fun ArrayBuffer.Slice  ");
        ...
        for (var i = start, ii = 0; i < end; i++, ii++) {
            ...
            console.log("ArrayBufferSlice 2 ");
