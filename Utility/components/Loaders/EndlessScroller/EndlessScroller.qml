...
Rectangle {
    ...
    property bool delegateHasSizeAuthority  : false
...
//                    console.log('ADJUST')
            ...
            delegate : Loader {
                ...
                onLoaded : {
                    if(!delegateHasSizeAuthority) {
                        item.anchors.fill = gvDelLoader
                    }
                    else {
                        gvDelLoader.width = Qt.binding(function() {  return item ? item.width : gv.cellWidth  })
                        gvDelLoader.height = Qt.binding(function() { return item ? item.height : gv.cellHeight })
                    }
