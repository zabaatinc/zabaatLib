.import "inflate.js" as Inflate
.import "deflate.js" as Deflate
.import "crc32.js" as Crc32
 ...
 function zip(data, options) {
     ...
     putLong(parseInt(Crc32.crc32(data), 16), out);
...
//     console.log("unzipping", data)
     ...
     crc = readLong(arr);
     if (crc !== parseInt(Crc32.crc32(res), 16)) {
//         console.log(parseInt(Crc32.crc32(res), 16), crc)
