...
//                    hash |= 0; // Convert to 32bit integer
    ...
    readonly property color lightText : isDarkColor (text1) ? text2 : text1
    readonly property color darkText  : isLightColor(text1) ? text2 : text1

    property SvgColors names : SvgColors {  }

    property QtObject darker : QtObject {
        property color accent    : Qt.darker(rootObject.accent )
        property color danger    : Qt.darker(rootObject.danger )
        property color warning   : Qt.darker(rootObject.warning)
        property color success   : Qt.darker(rootObject.success)
        property color info      : Qt.darker(rootObject.info   )
        property color standard  : Qt.darker(rootObject.standard)
        property color text1     : Qt.darker(rootObject.text1   )
        property color text2     : Qt.darker(rootObject.text2   )
        property color gray      : Qt.darker(rootObject.gray)
        property color lightText : Qt.darker(rootObject.lightText)
        property color darkText  : Qt.darker(rootObject.darkText)
    }
    property QtObject lighter : QtObject {
        property color accent   : Qt.lighter(rootObject.accent )
        property color danger   : Qt.lighter(rootObject.danger )
        property color warning  : Qt.lighter(rootObject.warning)
        property color success  : Qt.lighter(rootObject.success)
        property color info     : Qt.lighter(rootObject.info   )
        property color standard : Qt.lighter(rootObject.standard)
        property color text1    : Qt.lighter(rootObject.text1   )
        property color text2    : Qt.lighter(rootObject.text2   )
        property color gray     : Qt.lighter(rootObject.gray)
        property color lightText : Qt.lighter(rootObject.lightText)
        property color darkText  : Qt.lighter(rootObject.darkText)
    }
    property QtObject contrasting : QtObject {
        property color accent    : getContrastingColor(rootObject.accent,1.2 )
        property color danger    : getContrastingColor(rootObject.danger,1.2 )
        property color warning   : getContrastingColor(rootObject.warning,1.2)
        property color success   : getContrastingColor(rootObject.success,1.2)
        property color info      : getContrastingColor(rootObject.info   ,1.2)
        property color standard  : getContrastingColor(rootObject.standard,1.2)
        property color text1     : getContrastingColor(rootObject.text1   ,1.2)
        property color text2     : getContrastingColor(rootObject.text2   ,1.2)
        property color gray      : getContrastingColor(rootObject.gray,1.2)
        property color lightText : getContrastingColor(rootObject.lightText,1.2)
        property color darkText  : getContrastingColor(rootObject.darkText,1.2)
    }
...
//  these should all happen automatically by nature of bindings
